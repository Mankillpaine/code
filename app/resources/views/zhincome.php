    ...
    <div class="zh_income">
        <ul>
            ...
            <?php }
                ...
                foreach ($zbincome as $key =>$value) {  ?>
            <li>
                <span><?php echo $value->idate;  ?></span>
                <span><?php echo $value->income; ?></span>
                <span> <?php echo $value->increase; ?></span>
            </li>
            <?php  } }
...
<script>
    ...
    foreach ($zbincome as $key =>$value)
    {  ?>
    addData(myChart,"<?php echo $value->idate;  ?>",<?php echo $value->increase; ?>);
