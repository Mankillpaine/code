...
<div class="wapper" id="page">
    ...
    <div class="bigone" style="position:relative;overflow:hidden">
        <div style="position:relative;overflow:hidden">
            <div class="titleone">
                <a href="<?php echo ROOT_URL;  ?>/fans"<?php if(!$id) {echo "style='color:#51a5fe;font-size:0.32rem;border-bottom:2px solid #51a5fe;'";} ?>>全网排行</a>
                <a href="<?php echo ROOT_URL;  ?>/fans/platform/1" <?php if($id){echo "style='color:#51a5fe;font-size:0.32rem;border-bottom:2px solid #51a5fe; '";}   ?>  class="last">平台排行</a>
            </div>
            <div class="con">
                <div class="list1-title" <?php if($id){echo "style='display:block; '";}   ?>>
                    <a href="<?php echo ROOT_URL;  ?>/fans/platform/1" <?php if($id==1){echo "style='color:#51a5fe;font-weight:bold; '";}   ?>>映客直播</a>
                    <a href="<?php echo ROOT_URL;  ?>/fans/platform/3" <?php if($id==3){echo "style='color:#51a5fe;font-weight:bold; '";}   ?> >花椒直播</a>
                    <a href="<?php echo ROOT_URL;  ?>/fans/platform/7" <?php if($id==7){echo "style='color:#51a5fe;font-weight:bold; '";}   ?> >一直播</a>
