...
<head>
    ...
    <title>头部 - 单日主播热度榜</title>
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/common.css">
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/onedayanchorlist.css">
</head>
<body>
    <!--公共头部 start-->
        ...
        <div class="anchorcomindex-main-right fr">
            <div class="table">
                <div class="table-head clearfix rel">
                    <h2 class="fl" style="font-size:20px;height:auto;line-height:28px; margin-bottom:0px;">娱乐主播活跃指数 TOP100</h2>
                    ...
                    <ul class="list-nav fl hidden">
                        <li class="list-item fl"><a class="link-wh-100 <?php  if(!isset($_GET['platform'])) {   echo 'sel';   } ?> " href="/dayhot">全平台</a></li>
                        <?php foreach ($platform as $key => $value){   ?>
                            <li class="list-item fl"><a class="link-wh-100 <?php  if(isset($_GET['plat'])) {  if($_GET['plat'] ==$value->id){ echo 'sel'; }  } ?>" href="/dayhot?plat=<?php echo $value->id;    ?>" ><?php  echo $value->name;  ?></a></li>
                        <?php  } ?>
                    ...
                    <?php foreach ($result as $key =>$value) {  ?>
                        ...
                        <div class="table-td fl">
                            <span class="user-terrace db"><?php
                                ...
                                else if($value->platform ==4) {echo "熊猫直播"; }
                                else if($value->platform ==5) {echo "全民直播"; }
                        ...
                        <div class="table-td fl">
                            <span class="user-income hidden center fl">+<?php echo $value->increase_rmb."元"; ?></span>
                            <span class="user-total hidden center fl" style="font-size:14px;">总:<?php echo $value->rmb; ?>元
                               </span>
                        </div>
                        <div class="table-td fl">
                            <span class="user-income hidden center fl"><?php echo $value->increase_follower;  ?></span>
                            <span class="user-total hidden center fl" style="font-size:14px;">总:<?php echo $value->follower; ?></span>
                        </div>
                        <div class="table-td fl">
                            <span class="user-comprehensive hidden db"><?php echo $value->indexnum; ?></span>
                        </div>
                        <div class="table-td fl">
                            <!-- 三种可能：-->
                            <!-- ico-new - 最热 -->
                            <!-- ico-rise - 上升 -->
                            <!-- ico-drop - 下降 -->
                            <span class="ico <?php if($value->indexnum>$value->num){echo "ico-rise";}else if($value->indexnum<$value->num){echo "ico-drop";}else{echo "ico-new"; } ?> sprite fl"></span>
                        </div>
                        <div class="table-td fl">
...
<script src="<?php echo HTTP_URL; ?>web/static/js/onedayanchorlist.bundle.js"></script>
</body>
</html>