...
<head>
    ...
    <title>头部 - 主播综合指数总榜</title>
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/common.css">
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/anchorcomindex.css">
</head>
<body>
    <!--公共头部 start-->
            ...
            <div class="anchorcomindex-main-right fr">
                <div class="table">
                    <div class="table-head clearfix rel">
                        <h2 class="fl" style="font-size:20px;height:auto;line-height:28px;">娱乐主播综合指数 TOP100</h2>
                        ...
                        <ul class="list-nav fl hidden">
                            <li class="list-item fl"><a class="link-wh-100 <?php  if(!isset($_GET['plat'])) { echo 'sel'; }   ?> " href="/rmball">全平台</a></li>
                            <?php foreach ($plat as $key => $value){   ?>
                                <li class="list-item fl"><a class="link-wh-100 <?php  if(isset($_GET['plat'])) {  if($_GET['plat'] ==$value->id){ echo 'sel'; }  } ?>" href="/rmball?plat=<?php echo $value->id;    ?>" ><?php  echo $value->name;  ?></a></li>
                            <?php  } ?>
                        </ul>
                        <!-- 平台导航 end -->
                    ...
                    <div class="table-thead">
                        <div class="table-tr clearfix">
                            ...
                            <div class="table-th fl">综合指数<span class="ico sprite rel">
                                <div class="ly-alert hide abs">
                                    <p>“娱乐主播综合指数”是根据主播的粉丝、收入、在线时长等数据结合专业算法得出的指数值，指数值越高排名越高。</p>
                                </div>
                    ...
                    <div class="table-tbody">
                        ...
                        <?php foreach ($result as $key =>$value) {  ?>
                            ...
                            <div class="table-td fl">
                                <span class="user-income hidden center fl"><?php echo $value->follower;  ?></span>
<!--                                <span class="user-total hidden center fl">总:--><?php //echo $value->increase_follower;  ?><!--</span>-->
                            </div>
                            <div class="table-td fl">
...
<script src="<?php echo HTTP_URL; ?>web/static/js/anchorcomindex.bundle.js"></script>
</body>
</html>