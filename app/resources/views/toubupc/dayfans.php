...
<head>
    ...
    <title>头部 - 单日主播粉丝榜</title>
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/common.css">
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/onedayanchorfans.css">
</head>
<body>
    <!--公共头部 start-->
            ...
            <div class="anchorcomindex-main-right fr">
                <div class="table">
                    <div class="table-head clearfix rel">
                        <h2 class="fl" style="font-size:20px;height:auto;line-height:28px; margin-bottom:0px;">单日主播粉丝榜 TOP100</h2>
                        ...
                        <ul class="list-nav fl hidden">
                            <li class="list-item fl"><a class="link-wh-100 <?php  if(!isset($_GET['plat'])) { echo 'sel'; }   ?> " href="/dayfans">全平台</a></li>
                            <?php foreach ($plat as $key => $value){   ?>
                                <li class="list-item fl"><a class="link-wh-100 <?php  if(isset($_GET['plat'])) {  if($_GET['plat'] ==$value->id){ echo 'sel'; }  } ?>" href="/dayfans?plat=<?php echo $value->id;    ?>" ><?php  echo $value->name;  ?></a></li>
                            <?php  } ?>
                        </ul>
                        <!-- 平台导航 end -->
                    ...
                    <div class="table-tbody">
                        ...
                        <a class="table-tr db hidden clearfix" href="/zbdetail?id=<?php  echo $value->platform;  ?>&platformid=<?php echo $value->platformid;  ?>">
                            ...
                            <div class="table-td fl">
                                <span class="user-fans hidden center fl"><?php echo $value->follower ?></span>
                            </div>
                            <div class="table-td fl">
                                <span class="user-addfans hidden center fl">+<?php echo $value->increase_follower; ?></span>
                            </div>
                            <div class="table-td fl">
...
<script src="<?php echo HTTP_URL; ?>web/static/js/onedayanchorfans.bundle.js"></script>
</body>
</html>