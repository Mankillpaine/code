...
<head>
    ...
    <title>头部 - 平台活跃指数</title>
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/common.css">
    <link rel="stylesheet" href="<?php echo HTTP_URL; ?>web/static/css/terraceindex.css">
</head>
<body>
    <!--公共头部 start-->
        ...
        <div class="ly-1210 clearfix">
            ...
            <div class="anchorcomindex-main-right fr">
                ...
                <div class="table-label">
                    <p>“直播平台活跃指数”是根据平台主播人数、主播收入、用户活跃度、平均活跃时长等相关数据经过专业算法得出指数趋势。</p>
                </div>
                <!-- 说明 end -->
            </div>
            <!-- 右边内容块 end -->
...
<script src="<?php echo HTTP_URL; ?>web/static/js/terraceindex.bundle.js"></script>
</body>
</html>