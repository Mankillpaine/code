...
<template>
    <div id="p-agentset">
        <header class="header">
            <span class="title h-100 font-18 font-bold fl">经纪人设置</span>
        </header>
        <section class="fn-block text-center">
            ...
            <p class="di font-16 c-pointer"
               @click="addAgent">添加经纪人</p>
        </section>
        <section class="table">
            <div class="table-thead clear">
                <span class="table-th di h-100 font-16 font-bold text-center fl">经纪人</span>
                <span class="table-th di h-100 font-16 font-bold text-center fl">旗下主播</span>
                <span class="table-th di h-100 font-16 font-bold text-center fl">添加日期</span>
                <span class="table-th di h-100 font-16 font-bold text-center fl">操作</span>
            </div>
            <ul class="table-tbody">
                <li class="table-tr clear">
                    <div class="table-td h-100 font-16 text-center text-hidden fl">经纪人</div>
                    <div class="table-td h-100 font-16 text-center text-hidden fl">30名</div>
                    <div class="table-td h-100 font-16 text-center text-hidden fl">添加日期</div>
...
// 暴露组件配置
export default Object.assign({ name: 'p-agentset' }, { data, methods, components });
</script>