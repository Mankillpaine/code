...
<template>
    <div id="p-ystlanchor">
    	<header class="ys-header">
			<span class="title h-100 font-18 font-bold fl">昨日上播时常最高主播</span>
		...
		<section class="ys-main">
			...
			<ul class="table-tbody">
				<li class="table-tr c-pointer clear" v-for="item of ysTopLivetime">
...
// 暴露组件配置
export default Object.assign({ name: 'p-ystlanchor' }, vm);
</script>
