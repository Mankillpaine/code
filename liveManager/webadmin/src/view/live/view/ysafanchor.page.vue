...
<template>
    <div id="p-ysafanchor">
    	<header class="ys-header">
			<span class="title h-100 font-18 font-bold fl">昨日增粉最高主播</span>
		...
		<section class="ys-main">
			...
			<ul class="table-tbody">
				<li class="table-tr c-pointer clear" v-for="item of ysTopFans">
...
// 暴露组件配置
export default Object.assign({ name: 'p-ysafanchor' }, vm);
</script>
