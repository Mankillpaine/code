...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "E:\\www\\pro\\liveManager\\webadmin\\src\\view\\live\\view\\currolanchor.page.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-9c937f68"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-9c937f68", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-9c937f68", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] currolanchor.page.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/.0.26.1@css-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/style-rewriter.js?id=data-v-9c937f68&scoped=true!./../../../../node_modules/.2.2.3@less-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/selector.js?type=styles&index=0!./currolanchor.page.vue", function() {
				var newContent = require("!!./../../../../node_modules/.0.26.1@css-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/style-rewriter.js?id=data-v-9c937f68&scoped=true!./../../../../node_modules/.2.2.3@less-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/selector.js?type=styles&index=0!./currolanchor.page.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n#p-currolanchor[data-v-9c937f68] {\n  /*头部样式*/\n  /*内部样式*/\n}\n#p-currolanchor .curr-header[data-v-9c937f68] {\n  height: 50px;\n  background: #fff;\n  /*今日总览刷新*/\n}\n#p-currolanchor .curr-header .title[data-v-9c937f68] {\n  margin-left: 20px;\n  line-height: 50px;\n}\n#p-currolanchor .curr-header .autoref[data-v-9c937f68] {\n  margin-top: 19px;\n  margin-right: 20px;\n  color: #757b81;\n  1line-height: 14px;\n}\n#p-currolanchor .curr-header .autoref .ico[data-v-9c937f68] {\n  animation: refrotate 3s linear infinite;\n}\n@keyframes refrotate {\n0% {\n    transform: rotate(0deg);\n}\n50% {\n    transform: rotate(180deg);\n}\n100% {\n    transform: rotate(360deg);\n}\n}\n#p-currolanchor .curr-main[data-v-9c937f68] {\n  margin: 20px;\n  background: #fff;\n}\n#p-currolanchor .table-tr[data-v-9c937f68] {\n  height: 78px;\n  border-bottom: 1px solid #eaeaea;\n}\n#p-currolanchor .table-tr[data-v-9c937f68]:hover {\n  transition: all .2s;\n  border-bottom-color: #fff;\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.3);\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(1),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(1) {\n  width: 28%;\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(2),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(2) {\n  width: 16%;\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(3),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(3) {\n  width: 14%;\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(4),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(4) {\n  width: 16%;\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(5),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(5) {\n  width: 10%;\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(6),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(6) {\n  width: 6%;\n}\n#p-currolanchor .table-th[data-v-9c937f68]:nth-child(7),\n#p-currolanchor .table-td[data-v-9c937f68]:nth-child(7) {\n  width: 10%;\n}\n#p-currolanchor .table-th[data-v-9c937f68] {\n  height: 56px;\n  line-height: 56px;\n  border-bottom: 2px solid #eaeaea;\n}\n#p-currolanchor .table-td[data-v-9c937f68] {\n  line-height: 78px;\n}\n#p-currolanchor .table-td img[data-v-9c937f68] {\n  width: 52px;\n  height: 52px;\n  color: #333c44;\n  margin-top: 12px;\n  margin-left: 20px;\n}\n#p-currolanchor .table-td .username[data-v-9c937f68] {\n  height: 26px;\n  margin-left: 93px;\n  margin-top: 11px;\n  line-height: 26px;\n}\n#p-currolanchor .table-td .platform[data-v-9c937f68] {\n  height: 26px;\n  margin-left: 93px;\n  color: #aaa;\n  line-height: 26px;\n}\n#p-currolanchor .table-td .game[data-v-9c937f68] {\n  height: 27px;\n  margin-top: 11px;\n  line-height: 27px;\n}\n#p-currolanchor .table-td .rmb[data-v-9c937f68] {\n  height: 25px;\n  color: #aaa;\n  line-height: 25px;\n}\n#p-currolanchor .table-footer[data-v-9c937f68] {\n  height: 72px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 请求当前在线最高主播
	var postMaxOnline = function postMaxOnline(API, vm) {
	...
	var watch = _defineProperty({}, 'refTime', function refTime(curr) {
	    ...
	    // 异步调用新数据
	    if (curr === 0) {
	        var API_MAXONLINE = vm.$store.state.api.todayall.maxOnline;
	        ...
	        postMaxOnline(API_MAXONLINE, vm, {
	            total: vm.limit,
	            page: vm.index
	...
	var methods = {
	    ...
	    switchPage: function switchPage(index) {
	        var vm = this,
	            API_MAXONLINE = vm.$store.state.api.todayall.maxOnline;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      "isShow": _vm.maxOnline.length === 0,
	      "h": "300px"
	    }
	  }, [_c('ul', {
	    staticClass: "table-tbody"
	  }, _vm._l((_vm.maxOnline), function(item) {
	    return _c('router-link', {
	      ...
	      staticClass: "username text-hidden"
	    }, [_vm._v(_vm._s(item.remark || item.nickname))]), _vm._v(" "), _c('div', {
	      staticClass: "platform text-hidden"
	    }, [_vm._v(_vm._s(item.platname))])]), _vm._v(" "), _c('div', {
	      staticClass: "table-td h-100 font-16 text-center text-hidden fl"
	    }, [_vm._v(_vm._s(item.online) + "人")]), _vm._v(" "), _c('div', {
	      staticClass: "table-td h-100 font-16 text-center text-hidden fl"
	    }, [_vm._v(_vm._s(_vm._f("morh")(item.workTime)))]), _vm._v(" "), _c('div', {
	      staticClass: "table-td h-100 font-16 text-center fl"
	    }, [_c('div', {
	      staticClass: "game text-hidden"
	    }, [_vm._v(_vm._s(item.income) + "花椒币")]), _vm._v(" "), _c('div', {
	      staticClass: "rmb text-hidden"
	    }, [_vm._v(_vm._s(item.rmb) + "人民币")])]), _vm._v(" "), _c('div', {
	      staticClass: "table-td h-100 font-16 text-center text-hidden fl"
	    }, [_vm._v(_vm._s(item.recommend || '-'))]), _vm._v(" "), _c('div', {
	      staticClass: "table-td h-100 font-16 text-center text-hidden fl"
	  ...
	  return _c('div', {
	    ...
	    staticClass: "table-th font-16 font-bold text-center fl"
	  }, [_vm._v("当前在线人数")]), _vm._v(" "), _c('div', {
	    staticClass: "table-th font-16 font-bold text-center fl"
	  }, [_vm._v("当前在线时长")]), _vm._v(" "), _c('div', {
	    staticClass: "table-th font-16 font-bold text-center fl"
	  }, [_vm._v("当前收入")]), _vm._v(" "), _c('div', {
	    staticClass: "table-th font-16 font-bold text-center fl"
	  }, [_vm._v("热门榜")]), _vm._v(" "), _c('div', {
	    staticClass: "table-th font-16 font-bold text-center fl"
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-9c937f68", module.exports)
	  }
	}
