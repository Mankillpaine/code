...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "E:\\www\\pro\\liveManager\\webadmin\\src\\view\\live\\view\\curricanchor.page.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-40cb8122"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-40cb8122", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-40cb8122", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] curricanchor.page.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/.0.26.1@css-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/style-rewriter.js?id=data-v-40cb8122&scoped=true!./../../../../node_modules/.2.2.3@less-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/selector.js?type=styles&index=0!./curricanchor.page.vue", function() {
				var newContent = require("!!./../../../../node_modules/.0.26.1@css-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/style-rewriter.js?id=data-v-40cb8122&scoped=true!./../../../../node_modules/.2.2.3@less-loader/index.js!./../../../../node_modules/.10.0.2@vue-loader/lib/selector.js?type=styles&index=0!./curricanchor.page.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n#p-curricanchor[data-v-40cb8122] {\n  /*头部样式*/\n  /*内部样式*/\n}\n#p-curricanchor .curr-header[data-v-40cb8122] {\n  height: 50px;\n  background: #fff;\n  /*今日总览刷新*/\n}\n#p-curricanchor .curr-header .title[data-v-40cb8122] {\n  margin-left: 20px;\n  line-height: 50px;\n}\n#p-curricanchor .curr-header .autoref[data-v-40cb8122] {\n  margin-top: 19px;\n  margin-right: 20px;\n  color: #757b81;\n  1line-height: 14px;\n}\n#p-curricanchor .curr-header .autoref .ico[data-v-40cb8122] {\n  animation: refrotate 3s linear infinite;\n}\n@keyframes refrotate {\n0% {\n    transform: rotate(0deg);\n}\n50% {\n    transform: rotate(180deg);\n}\n100% {\n    transform: rotate(360deg);\n}\n}\n#p-curricanchor .curr-main[data-v-40cb8122] {\n  margin: 20px;\n  background: #fff;\n}\n#p-curricanchor .table-tr[data-v-40cb8122] {\n  height: 78px;\n  border-bottom: 1px solid #eaeaea;\n}\n#p-curricanchor .table-tr[data-v-40cb8122]:hover {\n  transition: all .2s;\n  border-bottom-color: #fff;\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.3);\n}\n#p-curricanchor .table-th[data-v-40cb8122]:nth-child(1),\n#p-curricanchor .table-td[data-v-40cb8122]:nth-child(1) {\n  width: 30%;\n}\n#p-curricanchor .table-th[data-v-40cb8122]:nth-child(2),\n#p-curricanchor .table-td[data-v-40cb8122]:nth-child(2) {\n  width: 16%;\n}\n#p-curricanchor .table-th[data-v-40cb8122]:nth-child(3),\n#p-curricanchor .table-td[data-v-40cb8122]:nth-child(3) {\n  width: 21%;\n}\n#p-curricanchor .table-th[data-v-40cb8122]:nth-child(4),\n#p-curricanchor .table-td[data-v-40cb8122]:nth-child(4) {\n  width: 14%;\n}\n#p-curricanchor .table-th[data-v-40cb8122]:nth-child(5),\n#p-curricanchor .table-td[data-v-40cb8122]:nth-child(5) {\n  width: 7%;\n}\n#p-curricanchor .table-th[data-v-40cb8122]:nth-child(6),\n#p-curricanchor .table-td[data-v-40cb8122]:nth-child(6) {\n  width: 12%;\n}\n#p-curricanchor .table-th[data-v-40cb8122] {\n  height: 56px;\n  line-height: 56px;\n  border-bottom: 2px solid #eaeaea;\n}\n#p-curricanchor .table-td[data-v-40cb8122] {\n  line-height: 78px;\n}\n#p-curricanchor .table-td img[data-v-40cb8122] {\n  width: 52px;\n  height: 52px;\n  color: #333c44;\n  margin-top: 12px;\n  margin-left: 20px;\n}\n#p-curricanchor .table-td .username[data-v-40cb8122] {\n  margin-left: 93px;\n}\n#p-curricanchor .table-td .game[data-v-40cb8122] {\n  height: 27px;\n  margin-top: 11px;\n  line-height: 27px;\n}\n#p-curricanchor .table-td .rmb[data-v-40cb8122] {\n  height: 25px;\n  color: #aaa;\n  line-height: 25px;\n}\n#p-curricanchor .table-footer[data-v-40cb8122] {\n  height: 72px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 请求当前收入最高主播
	var postMaxIncome = function postMaxIncome(API, vm) {
	...
	var watch = _defineProperty({}, 'refTime', function refTime(curr) {
	    ...
	    // 异步调用新数据
	    if (curr === 0) {
	        var API_MAXINCOME = vm.$store.state.api.todayall.maxIncome;
	        ...
	        postMaxIncome(API_MAXINCOME, vm, {
	            total: vm.limit,
	            page: vm.index
	...
	var methods = {
	    ...
	    switchPage: function switchPage(index) {
	        var vm = this,
	            API_MAXINCOME = vm.$store.state.api.todayall.maxIncome;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      "isShow": _vm.maxIncome.length === 0,
	      "h": "300px"
	    }
	  }, [_c('ul', {
	    staticClass: "table-tbody"
	  }, _vm._l((_vm.maxIncome), function(item) {
	    ...
	    }, [_vm._v("+" + _vm._s(item.increase_rmb) + "元")]), _vm._v(" "), _c('div', {
	      staticClass: "rmb text-hidden"
	    }, [_vm._v("+" + _vm._s(item.increase_income + item.ratename))])]), _vm._v(" "), _c('div', {
	      staticClass: "table-td h-100 font-16 text-center fl"
	    }, [_c('div', {
	      staticClass: "game text-hidden"
	    }, [_vm._v(_vm._s(item.rmb) + "元")]), _vm._v(" "), _c('div', {
	      staticClass: "rmb text-hidden"
	    }, [_vm._v(_vm._s(item.income + item.ratename))])]), _vm._v(" "), _c('div', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-40cb8122", module.exports)
	  }
	}
