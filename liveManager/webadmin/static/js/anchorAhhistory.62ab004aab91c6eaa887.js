	...
	var vm = {
	   ...
	   created: function created() {
	      ...
	      vm.$http.post(API_LIVEHISTRY, {
	         ...
	         data.forEach(function (_ref2) {
	            ...
	            if (!obj[time]) {
	               obj[time] = [{ title: title, workTime: workTime, onlineMax: onlineMax, cover: cover, starttime: starttime }];
	            } else {
	               obj[time].push({ title: title, workTime: workTime, onlineMax: onlineMax, cover: cover, starttime: starttime });
	            };
	         });
	   ...
	   computed: {
	      ...
	      livePickUrl: function livePickUrl() {
	         return (0, _seturlService.setUrl)('/webadmin/static/images/live-not-pick.png');
	      }
	   },
	   filters: {
	      // 转换年月日
	      ...
	      dateStrFilter: _dateFilter.dateStrFilter
	   }
	};
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('li', {
	      ...
	      }, [_vm._v(_vm._s(_vm._f("dateStrFilter")(info.starttime, 'hh:mm:ss')) + "开播，时长" + _vm._s(_vm._f("morh")(info.workTime)) + "，最高在线" + _vm._s(info.onlineMax) + "人")])])
	    }))])
	  }))])])
	},staticRenderFns: []}
